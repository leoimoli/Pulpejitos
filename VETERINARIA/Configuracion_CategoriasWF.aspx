<%@ Page Title="VETERINARIA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Configuracion_CategoriasWF.aspx.cs" Inherits="Configuracion_CategoriasWF" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <!-- GRILLA DE CONSULTA -->
    <div class="row" id="DivGrillaCategoria" runat="server">
        <div class="col-12">
            <!-- Recent Order Table -->
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6">
                            <div class="form-group">
                                <label for="exampleFormControlInput1" style="color: blueviolet">Nombre Categoria</label>
                                <input type="text" runat="server" id="txtBuscarMarca" class="form-control" placeholder="Nombre Categoria">
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="exampleFormControlInput1" style="color: blueviolet">Nombre Categoria(*)</label>
                                <input type="text" runat="server" id="txtNombreCategoria" class="form-control" placeholder="Nombre Categoria">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
