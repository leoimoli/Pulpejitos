<%@ Page Title="VETERINARIA" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Configuracion_RazasWF.aspx.cs" Inherits="Configuracion_RazasWF" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <!-- GRILLA DE CONSULTA -->
    <div class="row" id="DivGrillaRaza" runat="server">
        <div class="col-12">
            <!-- Recent Order Table -->
            <div class="card card-table-border-none recent-orders" id="recent-orders">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-6">
                            <div class="form-group">
                                <label for="exampleFormControlInput1" style="color: blueviolet">Nombre Raza</label>
                                <input type="text" runat="server" id="txtBuscarRaza" class="form-control" placeholder="Nombre Raza">
                            </div>
                        </div>
                ...
                <div class="card-body pt-0 pb-5">
                    <table class="table card-table table-responsive table-responsive-large" style="width: 100%">
                        ...
                        <tbody>
                            <asp:Repeater ID="RepeaterRaza" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <td><%# Eval("idRaza") %></td>
                                        <td>
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-recent-order1">
                                                    <li class="dropdown-item">
                                                        <asp:LinkButton Text='<%# (Eval("Estado").ToString() == "Inactivo") ? "ACTIVAR" : "ELIMINAR" %>' CssClass="fa fa-times fa-lg" runat="server"
                                                            CommandArgument='<%# Eval("idRaza") %>' ID="btnEliminarRaza" OnCommand="btnEliminarRaza_Command" />
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
                    ...
                    <div class="form-footer pt-4 pt-5 mt-4 border-top">
                        <asp:Button Text="Nueva Raza" runat="server" OnClick="btnNueva_Click" CssClass="btn btn-primary btn-default"  />
                    </div>
                </div>
            </div>
        </div>
    </div>
    <!-- FORMULARIO DE ALTA RAZA -->
    <div class="row" id="DivAltaRaza" runat="server">
        <div class="col-lg-12">

            <div class="card card-default">
                <div id="divAltaRazaEncabezado" style="color: blueviolet" runat="server" class="card-header card-header-border-bottom">
                    <h2 style="color: blueviolet">Alta Raza</h2>
                </div>
                ...
                <div class="card-body">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="exampleFormControlSelect12" style="color: blueviolet">Especie</label>
                                <asp:DropDownList class="form-control" ID="cmbAlta_Especie" AutoPostBack="true" runat="server">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="exampleFormControlInput1" style="color: blueviolet">Nombre Raza(*)</label>
                                <input type="text" runat="server" id="txtNombreRaza" class="form-control" placeholder="Nombre Raza">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
