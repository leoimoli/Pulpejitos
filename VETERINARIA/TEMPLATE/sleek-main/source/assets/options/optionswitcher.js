        ...
        <div class="right-sidebar-container-2">
          <div class="slim-scroll-right-sidebar-2">
            ...
            <div class="right-sidebar-2-header">
              ...
              <p>Propiedades de la interfaz</p>
            ...
            <div class="right-sidebar-2-body" data-simplebar>
              <span class="right-sidebar-2-subtitle">Encabezado</span>
              <div class="no-col-space">
                <a href="javascript:void(0);" class="btn-right-sidebar-2 header-fixed-to btn-right-sidebar-2-active">Ajustado</a>
                <a href="javascript:void(0);" class="btn-right-sidebar-2 header-static-to">Estático</a>
              </div>

              <span class="right-sidebar-2-subtitle">Lateral</span>
              <div class="no-col-space">
                <select class="right-sidebar-2-select" id="sidebar-option-select">
                  <option value="sidebar-fixed">Predeterminado fijo</option>
                  <option value="sidebar-fixed-minified">Fijo minimal</option>
                  <option value="sidebar-fixed-offcanvas">Offcanvas fijo</option>
                  <option value="sidebar-static">Predeterminado estático</option>
                  <option value="sidebar-static-minified">Estático minimal</option>
                  <option value="sidebar-static-offcanvas">Offcanvas estático</option>
                </select>
              </div>

              <span class="right-sidebar-2-subtitle">Fondo encabezado</span>
              <div class="no-col-space">
              ...
              <span class="right-sidebar-2-subtitle">Fondo navegación</span>
              <div class="no-col-space">
              ...
              <span class="right-sidebar-2-subtitle">Espaciado</span>
              <div class="no-col-space">
                <a href="javascript:void(0);" class="btn-right-sidebar-2 btn-right-sidebar-2-active default-spacing-to">Defecto</a>
                <a href="javascript:void(0);" class="btn-right-sidebar-2 compact-spacing-to">Compacto</a>
              </div>

              <span class="right-sidebar-2-subtitle">Dirección</span>
              <div class="no-col-space">
                <a href="javascript:void(0);" class="btn-right-sidebar-2 btn-right-sidebar-2-active ltr-to">Izquierda</a>
                <a href="javascript:void(0);" class="btn-right-sidebar-2 rtl-to">Derecha</a>
              </div>
